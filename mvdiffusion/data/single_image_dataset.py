...
class SingleImageDataset(Dataset):
    def __init__(self,
        ...
        if single_image is None:
            ...
            # Filter the files that end with .png or .jpg '.png', '.jpg', '.webp','.jpeg',
            self.file_list = [file for file in file_list if file.endswith(( '.png', '.jpg', '.webp','.jpeg','.png'))]
        else:
            self.file_list = None
    ...
    def load_image(self, img_path, bg_color, return_type='np', Imagefile=None):
        ...
        if Imagefile is None:
            ...
            if image_input.mode != 'RGBA':
                ...
                carved_image = rembg.remove(input_image, session=self.bg_remover)  # [H, W, 4]
                mask = carved_image[..., -1] > 0
                kiui.write_image('temp.png', carved_image)
