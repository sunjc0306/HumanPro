...
if __name__ == '__main__':
    m_out = Mesh('debug/0_smplx.obj', hold_history=True, device=torch.device('cpu'))
    part_mesh = PartMesh(m_out, num_parts=8, bfs_depth=0)
    for i in range(part_mesh.n_submeshes):
        part_mesh[i].export(f'debug/0_smplx_{i}.obj')