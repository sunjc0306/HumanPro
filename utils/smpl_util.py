...
class SMPLX():
    ...
    def __init__(self):
        ...
        self.current_dir = "/mnt/data1/sjc/Human_data"  # new smplx file in ECON folder
        ...
        # )
        self.smpl_vert_seg_path =  '/mnt/data1/sjc1/TeCH-Xiu/data/body_data/smpl_vert_segmentation.json'
